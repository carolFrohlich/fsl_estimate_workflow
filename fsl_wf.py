...
workflow = pe.Workflow(name='moraldilemmaft', base_dir=working_dir)
...
info = dict(func=[['subject_id', ['moraldilemma_functional_nuisance_residuals']]], struct=[['subject_id','struct']])
